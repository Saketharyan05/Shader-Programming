...
//
// Expected uniforms:
//   uniform vec3  iResolution;   // viewport resolution, e.g. vec3(width,height,1)
//   uniform float iTime;         // time in seconds
//
// If your shader host already provides iResolution/iTime automatically, keep this
// as it is. If it uses u_resolution/u_time, rename the uniforms below or map them
